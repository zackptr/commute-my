    ...
    <main className="container mx-auto px-8 py-14 md:py-20">
      <TransitionWrapper>
              ...
              <form className="mt-5">
                <div className="relative rounded-md border border-dark-800">
                  <div className="relative flex flex-row gap-4 items-center border-b border-b-dark-800">
                    ...
                    <input
                      className="pl-16 py-3.5 pr-4 w-full placeholder:text-sm disabled:placeholder:text-dark-800"
                      placeholder="Origin"
                      disabled
                    />
                  </div>
                ...
                <p className="text-yellow-500 text-xs mt-4">
                  This feature is not currently available. We are working to
                  implement it in a future update and appreciate your patience.
                </p>
              </form>
            </div>
        ...
        <section className="mt-20">
          ...
          <p className="mt-2">
            The project aims to make public transportation in the Klang Valley
            more accessible to everyone, including tourists. No ads, no
            trackers, no paywalls — just reliable and seamless functionality
            wherever and whenever you need it.
          </p>
          <h2 className="mt-4 text-lg md:text-xl font-semibold">Motivation</h2>
          <p className="mt-2">
            Commute was developed for the public good, prioritising user
            protection from ads and malware found in alternative solutions. We
            believe software should be open, accessible, and secure.
          </p>
          <h2 className="mt-4 text-lg md:text-xl font-semibold">Open</h2>
          <p className="mt-2">
            We stay closely connected with our community, collaborating to make
            Commute even more valuable. Explore our source code and contribute
            on{" "}
            <Link
              to="https://github.com/zackptr/commute-my"
