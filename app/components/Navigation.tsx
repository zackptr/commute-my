...
export function Navigation() {
    return (
        <nav className="z-10 overflow-auto flex md:flex-col gap-2 md:justify-between items-center px-6 py-2 md:py-8 md:px-0 sticky order-1 md:order-0 md:top-0 md:w-24 md:h-screen bottom-0 left-0 h-20 bg-dark-900 md:border-t-0 md:border-r md:border-r-dark-800 border-t border-t-dark-800">
