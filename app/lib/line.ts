...
export const ampangLine: Line = {
    ...
    stations: [
        ...
        { id: "AG13", name: "Maluri", lat: 3.12329, lng: 101.727283, nearby: ["Sunway Velocity Mall"] },
        { id: "AG12", name: "Miharja", lat: 3.120973, lng: 101.717922, nearby: ["Viva Mall"] },
        { id: "AG11", name: "Chan Sow Lin", lat: 3.128105, lng: 101.715637, nearby: ["The Metro Mall"], interchangeStations: ["PY24", "SP11"] },
        { id: "AG10", name: "Pudu", lat: 3.134879, lng: 101.711957, interchangeStations: ["SP10"] },
        { id: "AG9", name: "Hang Tuah", lat: 3.140012, lng: 101.705984, nearby: ["Berjaya Times Square", "The Mitsui Shopping Park LaLaport Bukit Bintang City Centre"], interchangeStations: ["SP9", "MR4"], mosques: [
        ...
        { id: "AG6", name: "Bandaraya", lat: 3.155567, lng: 101.694485, nearby: ["SOGO Kuala Lumpur"], interchangeStations: ["SP6"] },
        { id: "AG5", name: "Sultan Ismail", lat: 3.161245, lng: 101.694109, interchangeStations: ["SP5"], connectingStations: ["MR9"] },
        { id: "AG4", name: "PWTC", lat: 3.166333, lng: 101.693586, nearby: ["Sunway Putra Mall"], interchangeStations: ["SP4"] },
...
export const sriPetalingLine: Line = {
    ...
    stations: [
        ...
        { id: "SP25", name: "Pusat Bandar Puchong", lat: 3.033194, lng: 101.616057, nearby: ["SetiaWalk"] },
        ...
        { id: "SP4", name: "PWTC", lat: 3.166333, lng: 101.693586, nearby: ["Sunway Putra Mall"], interchangeStations: ["AG4"]},
...
export const kelanaJayaLine: Line = {
    ...
    stations: [
        ...
        { id: "KJ20", name: "Taman Jaya", lat: 3.104086, lng: 101.645248, nearby: ["Amcorp Mall"] },
        { id: "KJ19", name: "Universiti", lat: 3.114616, lng: 101.661639, nearby: ["KL Gateway Mall"], mosques: [
            { name: "Masjid Ar-Rahman", distance: "450m", walkingTime: "6 min", lat: 3.1178179, lng: 101.6628105 }
        ] },
        { id: "KJ18", name: "Kerinchi", lat: 3.115506, lng: 101.668572, mosques: [
            { name: "Masjid Ar-Rahah", distance: "650m", walkingTime: "8 min", lat: 3.1137199, lng: 101.6687277 },
            { name: "Masjid Menara TM", distance: "360m", walkingTime: "4 min", lat: 3.1161164, lng: 101.6656948 }
        ] },
        { id: "KJ17", name: "Abdullah Hukum", lat: 3.118735, lng: 101.672897, nearby: ["Mid Valley Megamall", "The Gardens Mall", "KL Eco City"], mosques: [
            { name: "Masjid TNB", distance: "410m", walkingTime: "5 min", lat: 3.1177874, lng: 101.6709643 }
        ] },
        ...
        { id: "KJ11", name: "Kampung Baru", lat: 3.161386, lng: 101.706608, mosques: [
            { name: "Masjid Jamek Kg Baru", distance: "570m", walkingTime: "7 min", lat: 3.1642272, lng: 101.7012624 }
        ] },
        { id: "KJ10", name: "KLCC", lat: 3.158935, lng: 101.713287, nearby: ["Petronas Twin Towers", "Suria KLCC", "Avenue K"], mosques: [
            { name: "Masjid As-Syakirin", distance: "530m", walkingTime: "6 min", lat: 3.1572322, lng: 101.713708 }
        ] },
...
export const monorailKlLine: Line = {
    ...
    stations: [
        ...
        { id: "MR9", name: "Medan Tuanku", lat: 3.15935, lng: 101.69888, nearby: ["Quill City Mall Kuala Lumpur"], connectingStations: ["AG5", "SP5"] },
...
export const kajangLine: Line = {
  ...
  stations: [
    ...
    { id: "KG06", name: "Kota Damansara", lat: 3.150134, lng: 101.57869 },
    {
      ...
      lat: 3.14948,
      lng: 101.593925,
      nearby: ["IOI Mall Damansara", "Sunway Giza Mall"],
    },
    {
      id: "KG08",
      ...
      lat: 3.155301,
      lng: 101.609077,
      nearby: ["The Curve", "IPC Shopping Centre", "IKEA Damansara"],
    },
    {
      id: "KG09",
      name: "Bandar Utama",
      lat: 3.14671,
      lng: 101.618599,
      nearby: ["1 Utama Shopping Centre"],
    },
    {
      id: "KG10",
      ...
      lat: 3.13613,
      lng: 101.630539,
      nearby: ["Glo Damansara Shopping Mall"],
    },
    { id: "KG12", name: "Phileo Damansara", lat: 3.129864, lng: 101.642471 },
    {
      ...
      lat: 3.143444,
      lng: 101.662857,
      nearby: ["Pavilion Damansara Heights"],
    },
    ...
    },
    {
      ...
      lat: 3.142403,
      lng: 101.720156,
      nearby: ["The Exchange TRX", "Apple The Exchange TRX"],
      interchangeStations: ["PY23"],
    },
    {
      id: "KG21",
      name: "Cochrane",
      lat: 3.132829,
      lng: 101.722962,
      nearby: ["MyTOWN Shopping Centre", "IKEA Cheras", "Sunway Velocity Mall"],
      mosques: [
        {
          name: "Masjid Jamek Alam Shah",
          distance: "590m",
          walkingTime: "7 min",
          lat: 3.1350761,
          lng: 101.7180825,
    ...
    { id: "KG24", name: "Taman Midah", lat: 3.104505, lng: 101.732186 },
    {
      ...
      lat: 3.090989,
      lng: 101.740453,
      nearby: ["EkoCheras Mall", "Cheras LeisureMall"],
    },
    {
      id: "KG26",
...
export const putrajayaLine: Line = {
    ...
    stations: [
        ...
        { id: "PY08", name: "Sri Damansara Timur", lat: 3.207832, lng: 101.628716, nearby: ["Kompleks Desa Kepong"] },
        ...
        { id: "PY12", name: "Sri Delima", lat: 3.207108, lng: 101.665749, nearby: ["Brem Mall Shopping Complex"] },
